...
function AdminPage({ isMobile }) {
  ...
  const statusColor = { received: { bg: '#fef3c7', color: '#92400e' }, in_progress: { bg: '#dbeafe', color: '#1e40af' }, delivered: { bg: '#d1fae5', color: '#065f46' } };
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center', paddingTop: '16px', borderTop: '1px solid #f0f0f0' }}>
              ...
              {order.rimImageUrl && (
                <a href={order.rimImageUrl} target="_blank" rel="noreferrer"
                  style={{ padding: '8px 14px', borderRadius: '9999px', fontSize: '13px', fontWeight: '600', background: '#f3f4f6', color: '#374151', textDecoration: 'none', border: 'none' }}>
                  Rim Image
                </a>
              )}
...
export default function App() {
  ...
  const searchTargets = [
    ...
    { keywords: ['terms', 'conditions', 'privacy', 'policy', 'refund', 'legal', 'rights'], label: 'Terms & Conditions', action: () => { setPage('terms'); setMenuOpen(false); window.scrollTo({ top: 0, behavior: 'smooth' }); } },
  ...
  if (page === 'terms') {
    const sections = [
      {
        title: '1. Overview',
        content: `RimViz ("we", "us", "our") is an online visualisation service that creates digital images showing how selected rims will appear on a customer's vehicle. By submitting an order and completing payment, you agree to be bound by these Terms and Conditions. These terms apply to all customers worldwide.`,
      },
      {
        title: '2. The Service',
        content: `RimViz provides a digital rim visualisation service. Upon receiving your payment, uploaded images, and rim specifications, our team will produce a professionally edited visualisation image showing your chosen rims fitted to your vehicle. The visualisation is a digital representation intended to give you a realistic preview — it is not a guarantee of exact appearance once physical rims are installed, as lighting, camera angle, and vehicle condition may affect the final look.`,
      },
      {
        title: '3. Pricing',
        content: `The current price for one visualisation is R49.99 (South African Rand) or the equivalent in your local currency. Pricing is subject to change at any time. Orders are charged at the price displayed at the time of submission. All payments are processed securely through PayFast.`,
      },
      {
        title: '4. Turnaround Time',
        content: `We aim to deliver your completed visualisation within 24 to 48 hours of receiving your payment and uploaded images. Delivery times may vary during high demand periods. Your visualisation will be sent to the email address provided at checkout. RimViz is not liable for delays caused by incorrect email addresses provided by the customer.`,
      },
      {
        title: '5. Refund Policy',
        content: `All payments are non-refundable once your order has been submitted and payment has been processed. This is because work begins on your visualisation immediately after payment is confirmed. If you are not satisfied with your visualisation, we will redo it for free — one revision is included with every order at no additional cost. To request a revision, reply to your confirmation email with details of what you would like changed.`,
      },
      {
        title: '6. Revisions',
        content: `Every order includes one free revision. If you are unhappy with the result, contact us at visualiserstudios1@gmail.com within 7 days of receiving your visualisation. Please describe clearly what changes you require. We will deliver the revised visualisation within 48 hours. Additional revisions beyond the first may be subject to a fee at our discretion.`,
      },
      {
        title: '7. Image Requirements',
        content: `You are responsible for uploading clear, well-lit images of your vehicle and the rim you wish to visualise. Images must be in JPG or PNG format and must not exceed 35MB. RimViz reserves the right to request replacement images if the quality is insufficient to produce a professional result. We will contact you by email if this is the case.`,
      },
      {
        title: '8. Intellectual Property',
        content: `The completed visualisation image produced by RimViz is for your personal use only. You may share it on personal social media accounts. You may not resell, redistribute, or use the visualisation for commercial purposes without written permission from RimViz. RimViz retains the right to use completed visualisations as portfolio examples and marketing material unless you request otherwise in writing.`,
      },
      {
        title: '9. Privacy',
        content: `We collect your name, email address, phone number, and uploaded images solely for the purpose of fulfilling your order. Your personal information will not be sold or shared with third parties. Uploaded images are stored securely and automatically deleted after 30 days. Payments are processed by PayFast and we do not store any card or banking details.`,
      },
      {
        title: '10. Limitation of Liability',
        content: `RimViz provides a digital visualisation service only. We are not liable for any purchasing decisions made based on the visualisation. The visualisation is a preview tool and does not constitute professional automotive advice. Our total liability in any circumstance shall not exceed the amount paid for the order in question.`,
      },
      {
        title: '11. Changes to These Terms',
        content: `RimViz reserves the right to update these Terms and Conditions at any time. Changes will be posted on this page with an updated date. Continued use of the service after changes are posted constitutes acceptance of the new terms.`,
      },
      {
        title: '12. Contact',
        content: `For any questions regarding these Terms and Conditions, please contact us at visualiserstudios1@gmail.com. We aim to respond within 24 hours.`,
      },
    ];
      ...
      <div style={{ width: '100%', minHeight: '100vh', backgroundColor: 'white', fontFamily: '-apple-system, BlinkMacSystemFont, Segoe UI, Roboto, sans-serif' }}>
        ...
        <div style={{ paddingTop: '52px' }}>
          ...
          <div style={{ backgroundColor: 'black', textAlign: 'center', padding: isMobile ? '48px 20px 36px' : '80px 40px 60px' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '14px', margin: '16px auto 0', fontWeight: '300' }}>
          ...
          <footer style={{ backgroundColor: 'black', color: 'white', padding: isMobile ? '32px 16px' : '48px 24px' }}>
            <div style={{ maxWidth: '1280px', margin: '0 auto', textAlign: 'center' }}>
              <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', marginBottom: '16px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => { setPage('home'); setTimeout(() => scrollTo('support'), 100); }} style={{ background: 'none', border: 'none', color: '#9ca3af', fontSize: '14px', cursor: 'pointer' }}>Support</button>
                <a href="mailto:visualiserstudios1@gmail.com" style={{ color: '#9ca3af', fontSize: '14px', textDecoration: 'none' }}>Contact</a>
              </div>
              <p style={{ color: '#6b7280', fontSize: '14px' }}>Copyright © 2025 RimViz. All rights reserved.</p>
            </div>
          </footer>
        </div>
      </div>
      ...
      <footer style={{ backgroundColor: 'black', color: 'white', padding: isMobile ? '32px 16px' : '48px 24px' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', textAlign: 'center' }}>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', marginBottom: '16px', flexWrap: 'wrap' }}>
            ...
            <a href="mailto:visualiserstudios1@gmail.com"
              style={{ color: '#9ca3af', fontSize: isMobile ? '13px' : '14px', textDecoration: 'underline' }}>
              Contact
            </a>
          </div>
